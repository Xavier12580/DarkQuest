...
cd $dir_macros
tar -czvf e1039_MC.tar.gz /seaquest/users/xinlongl/projects/z_vtx_sensitivity/SpinQuest_official_branch/core-inst --transform='s,^seaquest/users/xinlongl/projects/z_vtx_sensitivity/SpinQuest_official_branch/,,'
tar -czvf input_MC.tar.gz G4_EMCal.C RecoE1039Sim_muongun.C src work data e1039_MC.tar.gz
...
do
	...
	CMD+=" file://$job_dir/gridrun_muongun.sh $n_events -300 $EMCal_pos $St3_pos_dif"
	echo $CMD
